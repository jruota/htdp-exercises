...
; (bundle '("a" "b" "c") 0) creates an infinite loop, since drop never drops any
; items and bundle is given the same arguments over and over again. Thus the
; result would be an infinitely long list of empty lists.