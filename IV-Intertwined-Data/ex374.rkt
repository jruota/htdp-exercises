...
(define (render-enum xe)
  (local ((define content (xexpr-content xe))
          ...
          ; Render the content of xit
          ; above img.
          (define (render-xit xit img)
            (above (render-item xit) img)))
    ; – IN –
    (foldr render-xit empty-image content)))
...
(define (render-item an-item)
  (local ((define content (first (xexpr-content an-item))))
    ; – IN –
    (cond
      ; NOTE: bulletize could be moved above cond;
