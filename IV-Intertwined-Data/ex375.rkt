...
; Since every item has to get a bullet point and since render-item is supposed
; to receive XItem.v2's only, it does not matter which conditional is true.

; The previous version had one function call instead of the two function calls
; (one for each conditional case) here.
